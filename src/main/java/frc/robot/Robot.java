...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    double xSpeed = -RobotContainer.joystick_0.getRawAxis(Constants.CTRL0_LY);
    double zRotation = RobotContainer.joystick_0.getRawAxis(Constants.CTRL0_RX) * (xSpeed > 0.2 || xSpeed < -0.2 ? 1.0 : 0.75) ;
    int pov_0 = RobotContainer.joystick_0.getPOV();
